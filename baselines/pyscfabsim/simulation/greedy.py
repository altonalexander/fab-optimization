...
def run_greedy():
    ...
    p.add_argument('--batch_strat', type=str, default='Demand', choices=['Max', 'Min', 'RoundRobin', 'Demand']) #Max,Min, RoundRobin, Demand
    a = p.parse_args()
    ...
    if a.seed is None:
        a.seed = random.randint(1, 10000)
    if a.rpt_mode is None:
        a.rpt_mode = False
